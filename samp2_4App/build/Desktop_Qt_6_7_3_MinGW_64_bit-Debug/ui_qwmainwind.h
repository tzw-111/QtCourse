...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actAbout->setCheckable(false);
        actAbout->setChecked(false);
        ...
        txtEdit->setGeometry(QRect(40, 0, 396, 136));
        QFont font1;
        ...
        menuBar->setGeometry(QRect(0, 0, 1060, 29));
        ...
        menuewfrsdff = new QMenu(menuBar);
        menuewfrsdff->setObjectName("menuewfrsdff");
        ...
        menuBar->addAction(menuewfrsdff->menuAction());
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        menuewfrsdff->setTitle(QCoreApplication::translate("QWMainWind", "ewfrsdff", nullptr));
    } // retranslateUi
